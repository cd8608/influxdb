...
func (s *Server) appendSnapshotterService() {
	...
	srv.With(s.DiagnosticService.InSnapshotterContext())
...
func (s *Server) appendMonitorService() {
	s.Monitor.With(s.DiagnosticService.InMonitorContext())
...
func (s *Server) appendRetentionPolicyService(c retention.Config) {
	...
	srv.MetaClient = s.MetaClient
	srv.TSDBStore = s.TSDBStore
	srv.With(s.DiagnosticService.InRetentionContext())
	s.Services = append(s.Services, srv)
}
...
func (s *Server) appendHTTPDService(c httpd.Config) {
	...
	srv.With(s.DiagnosticService.InHTTPDContext())
...
func (s *Server) appendCollectdService(c collectd.Config) {
	...
	srv.With(s.DiagnosticService.InCollectdContext())
	s.Services = append(s.Services, srv)
}
...
func (s *Server) appendOpenTSDBService(c opentsdb.Config) error {
	...
	srv.PointsWriter = s.PointsWriter
	srv.MetaClient = s.MetaClient
	srv.With(s.DiagnosticService.InOpenTSDBContext())
	s.Services = append(s.Services, srv)
	return nil
}
...
func (s *Server) appendGraphiteService(c graphite.Config) error {
	...
	srv.With(s.DiagnosticService.InGraphiteContext())
	s.Services = append(s.Services, srv)
	return nil
}
...
func (s *Server) appendPrecreatorService(c precreator.Config) error {
	...
	srv.MetaClient = s.MetaClient
	srv.With(s.DiagnosticService.InPrecreatorContext())
	s.Services = append(s.Services, srv)
	return nil
}
...
func (s *Server) appendUDPService(c udp.Config) {
	...
	srv.PointsWriter = s.PointsWriter
	srv.MetaClient = s.MetaClient
	srv.With(s.DiagnosticService.InUDPContext())
	s.Services = append(s.Services, srv)
}
...
func (s *Server) appendContinuousQueryService(c continuous_querier.Config) {
	...
	srv.Monitor = s.Monitor
	srv.With(s.DiagnosticService.InContinuousQuerierContext())
	s.Services = append(s.Services, srv)
}
...
func (s *Server) Open() error {
	...
	if s.config.Meta.LoggingEnabled {
		s.MetaClient.With(s.DiagnosticService.InMetaClientContext())
	}
	s.TSDBStore.WithLogger(s.Logger)
	if s.config.Data.QueryLogEnabled {
		s.QueryExecutor.With(s.DiagnosticService.InQueryContext())
	}
	s.PointsWriter.With(s.DiagnosticService.InPointsWriterContext())
	s.Subscriber.With(s.DiagnosticService.InSubscriberContext())
